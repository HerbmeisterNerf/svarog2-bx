...
import time
import threading
from rtspServer.start_video_record import start_video_record
    ...
    try:
        ...
        while True:
            ...
            if command == 'q':
                ...
                output_dir = os.path.join(os.getcwd(), f'cam{command[1]}_screenshots')
                ...
                if not recording_pipelines:
                    ...
                    for stream_name, info in cam_info.items():
                        pipeline = start_video_record(info['url'], f'cam_{stream_name}_videos', stream_name)
                        if pipeline:
