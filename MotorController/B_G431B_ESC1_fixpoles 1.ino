...
// Motor instance
BLDCMotor motor = BLDCMotor(4, 3.9, 273);
...
void setup() {
  ...
  motor.LPF_current_q.Tf = 0.0005f;  // 1ms default
  motor.LPF_current_d.Tf = 0.0005f;  // 1ms default

  motor.current_limit = 1;

  // velocity PI controller parameters
  // motor.PID_velocity.P = 1;
  // motor.PID_velocity.I = 200;
