...
############ Initializer ############
    ...
    def __init__(self,
        ...
        if CommonData.firstCSV == True:
            ...
            row = list(range(CommonData.telemetryParameters))
...
############ Methods ############
    ...
    def __formatdata(self) -> list:
        ...
        data.insert(13,float(self.current_packet.imu_acc_y))
        data.insert(14,float(self.current_packet.imu_acc_z))
