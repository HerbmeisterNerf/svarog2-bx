# Canonical 314-bit telemetry packet format (ground_station version).
# NOTE: legacy/rpi_main_mpu/messagePack.py uses a 311-bit variant — 3 extra bits
# here cover motor_fault, rpi_IO, and additional C/SD status fields.
# When updating the packet format, update both this file and main_mpu/hardware/DataSender.py.
class MessagePack:
